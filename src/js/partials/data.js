var data = [
  ...
  {'can could could' : "мочь физически (способность)"},
  {"cast cast cast" : "бросать (удочку в воду, повторения)"},
  ...
  {"dwell dwelt dwelt " : "обитать, пребывать"},
  // 49-60
  ...
  {"hold held held " : "держать, подержи"},
  {"hurt hurt hurt " : "причинять боль, ранить"},
  {"keep kept kept " : "держать, сохрани"},
  {"kneel knelt/-ed knelt/-ed " : "на колени"},
  {"knit knit/ted knit/ted " : "вязать"},
  {"know knew known " : "знать"},
  // 85-96
  {"lay laid laid " : "класть осторожно"},
  {"lead led led " : "руководить"},
  {"lean leant/-ed leant/-ed " : "опираться, прислоняться"},
  {"leap leapt/-ed leapt/-ed " : "перепрыгнуть"},
  {"learn learnt/-ed learnt/-ed " : "учиться, узнавать"},
  {"leave left left " : "уйти (в другое место)"},
  {"lend lent lent" : "одалживать, давать взаймы"},
  {"let let let" : "позволять, сдавать в наём"},
  {"lie lay lain" : "лгать, лежать"},
  {"light lit/-ghted lit/-ghted " : "освещать, зажигать"},
  {"lose lost lost " : "терять"},
  {"make made made " : "делать, заставлять"},
  // 97-108
  {"may might might " : "мочь (разрешение), иметь право"},
  {"mean meant meant " : "означать, подразумевать"},
  {"meet met met " : "встречать, знакомиться"},
  {"mishear misheard misheard " : "ослышаться, неверно понять сказанное"},
